          ...
          {certificates.map((cert, index) => (
            ...
            >
               <div className="h-40 bg-gray-900 relative overflow-hidden">
                 ...
                 {cert.certificate_image && <img src={cert.certificate_image} alt={cert.title} className="w-full h-full object-cover opacity-60 group-hover:opacity-90 group-hover:scale-105 transition-all duration-700"/>}
               </div>
               <div className="p-6">
           ...
           {achievements.map((ach, index) => (
             ...
             >
               <div className="w-full md:w-56 h-36 md:h-32 rounded-xl bg-gray-900 overflow-hidden flex-shrink-0 relative shadow-lg">
                  {ach.image ? <img src={ach.image} alt={ach.title} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500"/> : <div className="w-full h-full flex items-center justify-center text-yellow-500 bg-yellow-500/10"><Award className="w-10 h-10"/></div>}
               </div>
    ...
    <main className="pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto animate-fade-in-up">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
         ...
         <div className="glass-card p-2 rounded-2xl shadow-2xl order-1 md:order-2 rotate-1 hover:rotate-0 transition-transform duration-500">
            <img src={cert.certificate_image} alt={cert.title} className="w-full rounded-xl"/>
         </div>
      </div>
    </main>
  );
