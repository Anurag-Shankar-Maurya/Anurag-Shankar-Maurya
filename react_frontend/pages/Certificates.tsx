...
import { Award, ArrowRight, ArrowLeft, ExternalLink, Loader2, HelpCircle } from 'lucide-react';
    ...
    return (
      <main className="pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto animate-fade-in-up">
        <EmptyState
          ...
          description="The professional certification or credential record you are looking for may have been moved, renamed, or is currently unavailable."
          icon={HelpCircle}
          actionText="Back to Certificates"
          onAction={() => onNavigate({ type: 'CERTIFICATES' })}
          variant="general"
        />
      </main>
    );
