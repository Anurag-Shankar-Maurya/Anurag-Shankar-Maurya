      ...
      <ReactMarkdown
        ...
        components={{
          ...
          table({ children, ...props } : any) {
            return (
              <div className="w-full overflow-x-auto my-2 border border-[#E5E5E5] rounded-[1.5rem] shadow-none bg-white">
                <table className="min-w-[600px] md:min-w-full text-sm border-collapse m-0" {...props}>
                  {children}
                </table>
              </div>
            );
